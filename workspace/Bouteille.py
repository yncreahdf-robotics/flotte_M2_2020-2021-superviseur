...
def insert_Bouteille(BouteilleID, BouteilleName, VolumeDoseur, Emplacement):
	try:
		flotte_db=mysql.connector.connect(
			host='172.19.0.3',
			user='root',
		...
		sql="INSERT INTO Bouteille_tb (BouteilleID, BouteilleName, VolumeDoseur, Emplacement) VALUES(%s,%s,%s,%s)"
		val=(BouteilleID, BouteilleName, VolumeDoseur, Emplacement)
		mycursor=flotte_db.cursor()
		mycursor.execute("USE flotte_db")
